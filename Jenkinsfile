  ...
  stages {
    ...
    stage ('Nexus upload') {
      steps {
        ...
        nexusArtifactUploader artifacts: [[artifactId: 'myapp', classifier: '', file: 'target/myapp-4.0.2.war', type: 'war']], credentialsId: 'nexus3', groupId: 'com.mithun', nexusUrl: '54.226.205.193:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'jenkins', version: '4.0.2'      
      }
    }    
    stage ('Deploy') {
      steps {
